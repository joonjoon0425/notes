...
\section{Bellman Equation for Action-Value Function}
    ...
    \subsection{Bellman Equation for Action-Value Function}
        ...
        \end{proof}
    \subsection{Greedy Policy and $\varepsilon$-greedy Policy}
        ...
        \begin{defn}{Greedy Policy}{greedyPolicy}
            The \textbf{greedy policy} always selects the action with highest action value. That is, given an action-value function $q(s,a)$,
            the greedy policy $\pi$ is defined as following:
            \begin{equation}
                \pi(a|s) = \begin{cases}
        ...
        \begin{defn}{$\varepsilon$-greedy Policy}{epsGreedyPolicy}
            The \textbf{$\varepsilon$-greedy policy} always selects the greedy action, but with probability $\varepsilon$, it picks action randomly. That is, given an action-value function $q(s,a)$,
            the $\varepsilon$-greedy policy $\pi$ is defined as following:
            \begin{equation}
                \pi(a|s) = \begin{cases}
