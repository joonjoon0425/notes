...
\section{Solving The Bellman Optimality Equation}\label{sec:SolveBellmanOptEq}
    \subsection{Contraction Mapping Theorem}
        ...
        \begin{proof}
            ...
            The Cauchy sequence has a nice property; the Cauchy sequence always converges. This can be proved by using the properties of $\mathcal{R}$, that the $\mathcal{R}$ is a compact set.
            ...
            \begin{align}
                \|x_m - x_n\| &\leq \|x_m - x_{m-1}\| + \|x_{m-1} - x_{m-2}\| + \cdots + \|x_{n+1} - x_n\| \\
                              ...
                              &= \|x_1-x_0\| \frac{\gamma^n(1-\gamma^{m-n-2})}{1-\gamma} \\
