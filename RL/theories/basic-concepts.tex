    ...
    \subsection{Definition}
        ...
        \begin{defn}{Markov Decision Process}{MDP}
            ...
            \begin{itemize}
                ...
                \item $\pi(a|s)$ is the policy, a probability of agent choosing action $a$ in state $s$.
        ...
        We'll use following notations for expectation of rewards:
        \begin{itemize}
            \item $r(s,a) = \sum_{r \in \mathcal{R}(s,a)} p(r|s,a)r$
        \end{itemize}
