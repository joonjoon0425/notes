\section{Sarsa}
    ...
    \subsection{Implementation Detail}
        I usually intialize q value without taking account the terminal states. While traning the agent, when the agent meets terminal state,
        I just check it immediatedly and set the $q_t(s_{t+1},a_{t+1}) = 0$. Actually I don't even change the q value of terminal state to 0. I just leave it untouched.
    ...
    \subsection{Pros and Cons}
        ...
        Cons:
        \begin{itemize}
            \item It learns suboptimal policies first, due to the behavior of search for safe paths in the initial training process.
