...
\section{Policy Iteration} \label{sec:PolicyIteration}
    \subsection{Main Idea}
...
\section{Truncated Policy Iteration}
    \subsection{Main Idea}
        ...
        even when the convergence condition is not met. Truncated policy iteration algorithm is one of the instances of \textbf{general policy iteration}, which is
        an abstract concept of interleaving evaluation and improvement.
